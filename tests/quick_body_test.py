...
if __name__ == "__main__":
    ...
    print("Test with:")
    print(
        '  curl -X POST http://127.0.0.1:8888/simple -H "Content-Type: application/json" -d \'{"name": "Alice", "age": 30}\''
    )
    print(
        '  curl -X POST http://127.0.0.1:8888/model -H "Content-Type: application/json" -d \'{"name": "Bob", "email": "bob@example.com"}\''
    )
