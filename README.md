...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/zig-0.17.0--dev.1862-f7a41d?style=flat-square" alt="Zig 0.17.0-dev.1862" />
...
**Requirements:** Python 3.14+ free-threaded (`3.14t`), Zig 0.17.0-dev.1862+40ebd8162

TurboAPI pins the exact Zig nightly above across its manifest, CI, release,
Docker, and native build tooling. The prior `std.Io` migration background is in
[`docs/ZIG_0_16_MIGRATION.md`](docs/ZIG_0_16_MIGRATION.md).
...
**Requirements:** [Python 3.14t](https://docs.python.org/3.14/whatsnew/3.14.html) (free-threaded) and [Zig 0.17.0-dev.1862+40ebd8162](https://ziglang.org/download/)

The repo and CI are pinned to the exact nightly shown above so compiler and
standard-library changes cannot silently alter release builds.
...
- **[Zig 0.17-dev](https://ziglang.org)** — HTTP server, JSON validation, zero-copy I/O
