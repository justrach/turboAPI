...
pub fn build(b: *std.Build) !void {
    ...
    // -Diouring=true switches the transport to a per-connection
    // io_uring ring on Linux. No-op on other platforms.
    const iouring = b.option(bool, "iouring", "Use io_uring transport on Linux") orelse false;
...

    {
...

        {
            ...
            options.addOption(bool, "iouring", false);
